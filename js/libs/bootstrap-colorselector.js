...
(function($) {
  ...
  ColorSelector.prototype = {
    ...
    _init : function() {
      ...
      var $markupA = $("<a>").attr("data-toggle", "dropdown").addClass("dropdown-toggle").append($markupSpan);
      ...
      $("option", this.$select).each(function() {
        ...
        $markupA.attr("data-color", color).attr("data-value", value).attr("title", title);
